...
| ImageSize                                | ImageSize is the option for specifying Image size. If height & width is specified in #img_div container than it will automatically take containers height. If not, By default the height= 1000px, and width= Auto. To change image size user can manually change it as per requirement.<br />For eg. 'ImageSize':'1000', |         |
