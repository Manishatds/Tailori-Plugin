...
| IsOptionVisible                                 | If *true* Options such as straight cuff, beveled cuff, etc. will be displayed seperately,<br />If *false* Options and Features will be listed in same place.<br />For eg. 'Isoptions':'true'    | * <sup><sup>3</sup></sup> |
...
| MonogramPlace                               | Placing area to show Monogram on the apparel.<br />|         |
