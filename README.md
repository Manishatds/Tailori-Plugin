...
<pre>
1.  </pre>**detail id**   -     To show specific view of any product detail.
<pre>2.  </pre>**true**        -	  To show last selected specific view. 
<pre>3.  </pre>**false**       -	  To show normal view i.e., model or full view.
