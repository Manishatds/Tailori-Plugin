...
| OptionTemplate                                 | OptionTemplate is Created to display Product Options in the browser.<br />For displaying dynamically give template id of option here(it will render html contains dynamically when clicked on **product** i.e. click collar or cuff, etc.)             | * <sup><sup>1</sup></sup> |
