...
| -----------------------------------------------|------------| -------:|
| ServiceUrl                                     | ServiceuUrl is a url where we place all our data that we need to call, for e.g product, draping parts, buttons, fabrics, etc.    It will be provided to you by textronics.  | * |
